...
void *Thread_work(void* rank) {
   ...
   // implementa una barrera utilizando variables de condición y 
   //mutex para sincronizar varios hilos. Los hilos esperarán hasta 
   //que todos los hilos hayan llegado a la barrera antes de continuar 
   //su ejecución.
#  ifdef DEBUG
