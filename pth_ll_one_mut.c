...
/*-----------------------------------------------------------------*/
void* Thread_work(void* rank) {
   // utilizada por varios hilos para realizar operaciones de búsqueda, 
   //inserción y eliminación en una lista enlazada concurrentemente.
   // El uso del mutex mutex asegura que las operaciones en la lista 
   //se realicen de manera exclusiva para evitar problemas de 
   //concurrencia. 
